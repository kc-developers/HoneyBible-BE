...
public class ReadcheckController {
    ...
    @GetMapping("/dateReadBefore/{ttolae}/{name}/{dateKey}")
    public String getDateReadBefore(@PathVariable String ttolae, @PathVariable String name, @PathVariable String dateKey) {
